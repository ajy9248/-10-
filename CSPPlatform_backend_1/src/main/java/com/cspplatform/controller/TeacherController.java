...
public class TeacherController extends BaseController{
    ...
    public JsonResult<Void> deleteTeachers(String[] uid)
    {
        iTeacherService.deleteTeachers(uid);
    ...
    @RequestMapping("/TeacherInfo")//获取所有教师信息
    ...
    public JsonResult<Void> changeInfo(String uid,String uname,String identity){
        Teacher teacher=new Teacher(uid,uname,identity);
